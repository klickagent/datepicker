<div [ngClass]="{
     ...
     [ngStyle]="style"
     #container>
    <div *ngIf="!inline && customTemp.children.length == 0" class="owl-dateTime-inputWrapper" #textInput>
        ...
        <i class="owl-dateTime-cancel icon icon-owl-cancel" [hidden]="!value" (click)="clearValue($event)"></i>
    </div>
    ...
    <div class="owl-dateTime-dialog owl-state-default owl-corner-all"
        ...
        <div *ngIf="type ==='both' || type === 'calendar'" class="owl-calendar-wrapper owl-corner-all">
            ...
            <div class="owl-calendar" [hidden]="dialogType !== 3">
                ...
                <div class="owl-calendar-yearArrow left" (click)="generateYearList('prev')">
                    <i class="icon icon-owl-left-open"></i>
                </div>
                <div class="owl-calendar-yearArrow right" (click)="generateYearList('next')">
                    <i class="icon icon-owl-right-open"></i>
                </div>
            </div>
        </div>
        <div *ngIf="type ==='both' || type === 'timer'" class="owl-timer-wrapper owl-corner-all">
            <div class="owl-timer owl-hours">
                <div class="owl-timer-control" (click)="setHours($event, 'increase', hoursInput)">
                    <i class="icon icon-owl-up-open"></i>
                </div>
                ...
                <div class="owl-timer-control" (click)="setHours($event, 'decrease', hoursInput)">
                    <i class="icon icon-owl-down-open"></i>
                </div>
            </div>
        ...
        <div *ngIf="showButtons" class="owl-dateTime-btnWrapper">
            <div class="owl-dateTime-btn owl-corner-bottomLeft owl-dateTime-btnConfirm" (click)="onConfirmClick($event)">Confirm</div>
            <div class="owl-dateTime-btn owl-corner-bottomRight owl-dateTime-btnClose" (click)="onCloseClick($event)">Close</div>
        </div>
    </div>
</div>